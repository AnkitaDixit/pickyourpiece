...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "modern ring designs and price",
    "sleek ring designs and price",
    "traditional ring designs and price",
    "earring designs and price",
    "bracelet designs and price",
    "jewellery gifts for her",
    "jewellery gifts for him",
    "his and her rings",
    "valentine gift jewellery",
    "birthday gift jewellery",
    "anniversary gift jewellery",
    "anniversery gift jewellery",
